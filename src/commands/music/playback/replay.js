...
class ReplayCommand extends Command {
  ...
  async _handleReplay(context, pm) {
    ...
    container.addTextDisplayComponents(
      new TextDisplayBuilder().setContent('### Track Replayed'),
    );
    ...
    const trackInfo   =[
      ...
      `Duration: \`${currentTrack.info.isStream ? 'LIVE' : this._formatDuration(currentTrack.info.duration)}\``,
      `Requested by: <@${currentTrack.requester?.id || 'Unknown'}>`,
    ].join('\n');
